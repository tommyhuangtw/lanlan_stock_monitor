...
async function sendHelpReply(chatId: string | number): Promise<void> {
  const html = [
    ...
    '',
    '<b>查個股</b>  直接輸入代號',
    '→ 例：<code>/TSLA</code>、<code>/2330</code>、<code>/台積電</code>',
    '',
    '<b>查 KOL 觀點</b>  @ + 名稱',
    '→ 例：<code>@股癌</code>、<code>@NaNa</code>',
    '',
    '━━━━━━━━━━━━━━━',
    '📖 <b>系統運作說明</b>',
    '',
    '<b>追蹤來源</b>：KOL podcast 提到的看多股票 + AI 擴展相關概念股',
    '',
    '<b>入場分數</b>：技術訊號（回檔、RSI超賣、均線支撐）+ KOL 共識度 + 訊號新鮮度',
    '',
    '<b>市場熱度</b>（RSI 0-100）：',
    '🟦 0-30 偏冷 → 可能接近低點',
    '⬛ 30-60 中性',
